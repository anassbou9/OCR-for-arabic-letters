...
def objective(trial):
    ...
    for i in range(2,8):
            print(i)
            original_img, preprocessed_img = pre.preprocess("c:/Users/ab/Desktop/Anass/isima/OCR-for-arabic-letters/books_for_ocr/scanned_pics/test_"+str(i)+".PNG")
...
best_trial, best_params, best_value= study.best_trial, study.best_params, study.best_value
